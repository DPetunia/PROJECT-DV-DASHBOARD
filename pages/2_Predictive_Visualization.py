...
st.metric("R² (variance explained)", f"{r_squared:.2f}")
st.caption(
    "R² indicates how much of the variation in CGPA is explained by "
    "sleep, study hours, and attendance alone. The remaining variation "
    "is driven by other factors not captured by this simple model."
)
